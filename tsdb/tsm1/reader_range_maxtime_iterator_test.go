...

		{
			...
			tests: []test{
				...
				},
				{
					...
					exp:      EXP("tag0=val0", true, 2020, "tag0=val1", false, InvalidMinNanoTime, "tag0=val2", true, 2020),
					expStats: cursors.CursorStats{ScannedValues: 6, ScannedBytes: 48},
				},
				{
					name: "1000_2999",
	...
	runTests("after delete", []bucketTest{
		{
			...
			tests: []test{
				...
				},
				{
					...
					exp:      EXP("tag0=val1", false, InvalidMinNanoTime),
			...
			tests: []test{
				{
					...
					expStats: cursors.CursorStats{ScannedValues: 12, ScannedBytes: 96},
				},
				{
					name: "within block",
					args: args{
					...
					exp:      EXP("tag0=val1", false, InvalidMinNanoTime, "tag0=val2", false, InvalidMinNanoTime),
					expStats: cursors.CursorStats{ScannedValues: 3, ScannedBytes: 24},
				},
				{
					name: "1000_2500",
					...
					exp:      EXP("tag0=val1", true, 1020, "tag0=val2", false, InvalidMinNanoTime),
